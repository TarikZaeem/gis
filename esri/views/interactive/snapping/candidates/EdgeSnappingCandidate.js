...
//>>built
define("exports ../../../../chunks/_rollupPluginBabelHelpers ../SnappingConstraint ../snappingUtils ./FeatureSnappingCandidate ../hints/LineSnappingHint".split(" "),function(d,e,g,h,a,k){a=function(f){function b(c){return f.call(this,{...c,constraint:new g.LineConstraint(c.edgeStart,c.edgeEnd)})||this}e._inheritsLoose(b,f);e._createClass(b,[{key:"hints",get:function(){return[new k.LineSnappingHint(h.LineSegmentHintType.REFERENCE,this.constraint.start,this.constraint.end,this.isDraped,this.domain)]}}]);
